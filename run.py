...
def main():
    ...
    while True:
        print("Allowed Actions: \n cr - create a new user account with a user-defined password\n ca - create a new user account with a auto-generated password\n d - display all user accounts \n ex -exit  \n")
        ...
        if short_code == 'cr':
            print("New User")
            print("-"*10)
            print("Hey There!!! Who do you want to create an account for?")
            site = input()
